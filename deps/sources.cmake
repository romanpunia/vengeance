...
if (VI_SHADERS)
    ...
    foreach(BINARY ${SOURCE_SHADERS})
        ...
        if (NOT FILEDATA STREQUAL "")
            ...
            string(REGEX REPLACE "[\r\n]" "\\\\n" FILEDATA "${FILEDATA}")
            string(REGEX REPLACE "\\\"" "\\\\\"" FILEDATA "${FILEDATA}")
            string(APPEND BUFFER_DATA "\n\t\tconst char* ${VARNAME} = \"${FILEDATA}\";\n\t\tcallback(context, \"${FILENAME}\", ${VARNAME}, strlen(${VARNAME}));\n")
        endif()
    endforeach()
    string(APPEND BUFFER_DATA "\t}\n}\n#endif")
    ...
    message(STATUS "Pack resources into ${BUFFER_OUT}.hpp - OK")
else()
    file(WRITE "${BUFFER_OUT}.hpp" "")
    message(STATUS "Unpack resources from ${BUFFER_OUT}.hpp - OK")
endif()
...
if (VI_BULLET3)
    ...
    message(STATUS "Use library @bullet3 - OK")
endif()
if (VI_RMLUI)
	...
	if (VI_FREETYPE AND (Freetype_FOUND OR FREETYPE_LIBRARIES))
        ...
        message("Use library @freetype - failed")
	endif()
	list(APPEND SOURCE
        ${SOURCE_RMLUI_ALL}
        ${SOURCE_RMLUI})
    message(STATUS "Use library @rmlui - OK")
...
if (VI_VECTORCLASS)
    ...
    message(STATUS "Use library @vectorclass - OK")
endif()
